 ...
 */
final class Version20210928160015 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE movies ADD COLUMN relevante BOOLEAN DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__destacadas AS SELECT id, movies_id, title, text FROM destacadas');
        $this->addSql('DROP TABLE destacadas');
        $this->addSql('CREATE TABLE destacadas (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, title VARCHAR(255) DEFAULT NULL, text VARCHAR(255) DEFAULT NULL, movies_id INTEGER NOT NULL)');
        $this->addSql('INSERT INTO destacadas (id, movies_id, title, text) SELECT id, movies_id, title, text FROM __temp__destacadas');
        $this->addSql('DROP TABLE __temp__destacadas');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_731E324453F590A4 ON destacadas (movies_id)');
        ...
        $this->addSql('CREATE TABLE movies (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, nombre VARCHAR(255) NOT NULL, productora VARCHAR(255) DEFAULT NULL, anno VARCHAR(255) DEFAULT NULL, poster VARCHAR(255) DEFAULT NULL, fanart VARCHAR(255) DEFAULT NULL, descripcion CLOB DEFAULT NULL, url CLOB NOT NULL, idioma_subtitulo VARCHAR(255) DEFAULT NULL, duracion INTEGER DEFAULT NULL, director VARCHAR(255) DEFAULT NULL, genero VARCHAR(255) DEFAULT NULL)');
